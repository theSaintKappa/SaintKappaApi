...
router.get('/:userName', async (req, res) => {
    try {
        ...
        res.status(500).send(`<svg fill="none" xmlns="http://www.w3.org/2000/svg"><foreignObject width="100%" height="100%"><div xmlns="http://www.w3.org/1999/xhtml"><span>Badge failed to load</span></div></foreignObject></svg>`);
    }
});
